...
#define CUSTOM_MACHINE_NAME "slEnderman"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro - stock @ 240oC
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro - stock PCB @ 80oC
  #define DEFAULT_bedKp 186.20
  #define DEFAULT_bedKi  31.81
  #define DEFAULT_bedKd 726.20
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -15, -7.4 }
