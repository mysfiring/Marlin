...
#define STRING_CONFIG_H_AUTHOR "(mysfiring, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Stampy"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3D Titan Aero w/ Volcano @ 240oC; 60W
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 837 } // @ GT2 16T, GT2 16T, TR8 P2T2, E3D Titan Aero + 'Compact but powerful' 0.9 deg stepper
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 47, 0, -6.95 } // Hangtight's Titan Aero ABL Mount w/ PLA+
...
#define INVERT_E0_DIR true        // Titan Aero w/ E3D motor - true
